...
import Thorbot from "../../assets/Thorbot.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>What is your support request?</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot will answer questions specific to Thorlabs products.  This is a POC only.</h2>
                            </Stack>
                        ) : (
